...
class UpdateTests(unittest.TestCase):
    ...
    def setup_txt(self):
        kmeans = KMeans('/home/lorenz/PycharmProjects/sdm_kmeans/data/Skin_NonSkin.txt', 2)
        kmeans.import_data()
        kmeans.convert_data()
        return kmeans

    def setup_csv(self):
        kmeans = KMeans('/home/lorenz/PycharmProjects/sdm_kmeans/data/HTRU2/HTRU_2.csv', 2)
        kmeans.import_data()
        kmeans.convert_data()
        return kmeans
    ...
    def test_lloyd_update_csv(self):
        ...
        kmeans.clusters = init_strategy.init(k_clusters=2, point_cloud=kmeans.point_cloud)
